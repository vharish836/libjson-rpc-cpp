 ...
 * libjson-rpc-cpp
 *************************************************************************
 * @file    httpbasicauthserver.h
 * @date    19.04.2018
 * @author  Harish <vharish836@gmail.com>
 * @license See attached LICENSE.txt
 ************************************************************************/

#ifndef JSONRPC_CPP_HTTPBASICAUTHSERVERCONNECTOR_H_
#define JSONRPC_CPP_HTTPBASICAUTHSERVERCONNECTOR_H_
...
/**
     ...
     */
class HttpBasicAuthServer : public AbstractServerConnector
{
  public:
    /**
        * @brief HttpBasicAuthServer, constructor for the included HttpBasicAuthServer
        * @param port on which the server is listening
	    * @param username - request credentials validated aganist this
	    * @param password - request credentials validated aganist this
        ...
        */
    HttpBasicAuthServer(int port, const std::string &username, const std::string &password,
    ...
    HttpBasicAuthServer::FailureType ValidateCredentials(const char* username, const char* password);
...
#endif /* JSONRPC_CPP_HTTPBASICAUTHSERVERCONNECTOR_H_ */
